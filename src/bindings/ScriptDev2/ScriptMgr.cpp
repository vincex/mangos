...
// -- Guardian --
extern void AddSC_guardian_melee();

extern void AddSC_SnakeTrap();
extern void AddSC_CrimsonCannon();
extern void AddSC_TimbermawAncestor();
extern void AddSC_Shahram();
extern void AddSC_EmeraldDragonWhelp();
extern void AddSC_BattleChicken();
extern void AddSC_ExplosiveSheep();
...
void ScriptsInit()
{
	...
	// -- Guardian --
	AddSC_guardian_melee();

	AddSC_SnakeTrap();
	AddSC_CrimsonCannon();
	AddSC_TimbermawAncestor();
	AddSC_Shahram();
	AddSC_EmeraldDragonWhelp();
	AddSC_BattleChicken();
	AddSC_ExplosiveSheep();
